<template>
  <div>
    ...
    <!-- Begin pricing plan -->
    <section
      class="price-section parralax-section pt-xs-25 pt-md-25 pt-lg-60 pb-xs-25 pb-md-25 pb-lg-60"
    >
        ...
        <div class="prices-slider">
          <div class="tt-slide">
            <div class="prices-card">
              ...
              <div class="pricing-card__top lazy">
                <p>
                  <span>$7</span> / month
                </p>
              </div>
              <div class="pricing-card__content">
                <h4>
                  Price Plan -
                  <span class="theme-color">A</span>
                </h4>
                <div class="prisec-card__include">
                  <p>Large Mic Selection</p>
                  <p>3 Isolation Booths / Big Room</p>
                  <p>Pro Tools HD3</p>
                  <p>Tape Machine</p>
                </div>
                <div class="mt-5">
          ...
          <div class="tt-slide">
            <div class="prices-card popular-plan">
              ...
              <div class="pricing-card__content">
                <h4>
                  Price Plan -
                  <span class="theme-color">B</span>
                </h4>
                <div class="prisec-card__include">
                  <p>Genelec 8050's</p>
                  <p>Waves Platinum Bundle</p>
                  <p>Kontact</p>
                  <p>Neve Summing</p>
                  <p>SSL EQ</p>
                </div>
...
.pricing-card__top {
  background-image: url(".././assets/images/pricing-card.jpg");
}
...
.button.white.btn-border {
  ...
  border: 1px solid #d21c5e;
  border-radius: 30px;
  transition: all 0.3s;
  min-width: 140px;
}

.button.white.btn-border:hover {
  background: #d21c5e;
  border: 1px solid #d21c5e;
  border-radius: 30px;
  transition: all 0.3s;
...
/* .slide-enter-active {
  ...
  .slide-leave-active {
    animation: slideInDown .65s ease-in both;
  } 
